# Generated by Django 3.2 on 2022-07-24 04:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=False, verbose_name='逻辑删除')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SchSocialMedia.article', verbose_name='文章')),
            ],
            options={
                'verbose_name': '人物信息',
                'db_table': 'peopleinfo',
